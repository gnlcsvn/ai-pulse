...
topics: [AI predictions, robotics, self-driving, AI IPOs, consumer AI, foundation models, defense tech, GLP-1, neo labs, AI adoption]
duration: 40m
...
## Guests
- **Sarah Guo** - Partner, Greylock (co-host of No Priors)
- **Elad Gil** - Investor, entrepreneur (co-host of No Priors)

Plus guest predictions from friends of the show recorded as short video segments.
...
7. AI IPOs will surge in 2026 driven by massive retail appetite to participate in AI beyond NVIDIA [▶ 16:08](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=968s)
8. Consumer AI agent software will finally start to deliver magical, differentiated experiences in 2026 [▶ 17:10](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=1030s)
9. Defense tech startups and the shift to drone-based warfare systems will accelerate massively [▶ 26:46](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=1606s)
10. Code is a bootstrap into faster AGI development; code plus self-evolution may be the path to rapid capability liftoff [▶ 26:02](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=1572s)

## Notable Quotes
> "I think this is, by the way, super under discussed that the people who have tended to be the slowest adopters of technology love AI. That's physicians, that's lawyers, that's certain accounting types." - Elad Gil [▶ 5:19](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=319s)

> "The reality of the technology always take like 10 years to propagate and people are getting enormous value out of the AI already and they're going to get way more out of it in the future." - Elad Gil [▶ 3:05](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=185s)

> "I think we're going to see somebody make a lot of money, hundreds of millions of dollars, trading markets with LLMs next year. It's inevitable." - Sarah Guo [▶ 1:16](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=76s)

> "The most likely global winners in robotics will be some subset of China plus Tesla plus something else, right? Maybe one of the startups." - Elad Gil [▶ 9:21](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=561s)

> "You buy the IPO, regardless of your fundamental view of the company. And I was like, wow, this is not the investing job I know how to do." - Sarah Guo, quoting a hedge fund manager [▶ 16:03](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=963s)

> "Code is arguably a bootstrap into moving faster on development of AGI. But I think it's kind of code plus self-evolution is really the potential really interesting approach to it to get some really fast lift off." - Elad Gil [▶ 26:02](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=1572s)

> "I am seeing magical experiences of like really different consumer agent software that I like, I actually want and will use." - Sarah Guo [▶ 17:10](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=1030s)

> "The most striking thing about next year is that the other forms of knowledge work are going to experience what software engineers are feeling right now." - Guest contributor [▶ 38:16](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=2296s)

## Data Points & Numbers
| Data Point | Value | Source Timestamp |
|---|---|---|
| LLM trading profits prediction | **Hundreds of millions of dollars** | [▶ 1:16](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=76s) |
| Self-driving industry age | **15-17 years** | [▶ 8:14](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=494s) |
| Great consumer product people globally | **A few hundred** (per well-known consumer founder) | [▶ 20:13](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=1213s) |
| Americans who dislike AI | **About a third** | [▶ 38:55](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=2335s) |
| Data center power supply cost | **$10 per kilowatt hour** benchmark | [▶ 40:03](https://www.youtube.com/watch?v=TOsNrV3bXtQ&t=2403s) |
...
## Summary
Sarah Guo and Elad Gil deliver their annual 2026 AI forecast, covering the full landscape from foundation models to robotics to market dynamics. The episode opens with Sarah's bold prediction that someone will make hundreds of millions of dollars trading markets with LLMs, setting the tone for a prediction-dense conversation.

Elad leads with structural observations: AI bubble narratives will recur despite accelerating adoption, the next wave of AI verticals will consolidate at massive scale, and foundation models for physics and materials science will produce overhyped but ultimately transformative breakthroughs. He emphasizes a strikingly under-discussed trend -- that traditionally conservative professions like medicine, law, and accounting are among AI's fastest adopters.

The robotics discussion reveals a nuanced view. Sarah predicts sentiment collapse around some robotics companies in 2026 as timelines slip, even as the field progresses. Elad argues self-driving is the biggest near-term robotics story and predicts Tesla Optimus plus Chinese companies will likely dominate, though both agree startups have opportunity. On the market side, they expect a wave of AI IPOs driven by insatiable retail demand, with hedge funds feeling compelled to participate regardless of fundamentals.

Consumer AI emerges as a major theme, with Sarah expressing genuine excitement about novel consumer agent software she has personally experienced, while predicting consumer AI hardware will mostly fail. Elad notes a puzzling dearth of consumer AI innovation despite two years of powerful models, attributing it partly to a limited pool of great consumer product people and partly to intimidation by incumbents.

The episode concludes with guest predictions spanning reasoning systems revolutionizing all industries, enterprise AI agents becoming dominant, the US regaining open-weight model leadership, AI becoming politicized in midterm elections, AI drug discovery entering deployment, energy efficiency becoming critical for data centers, and knowledge work broadly experiencing the same AI-driven transformation that software engineering underwent.
